...
while True : 
    #menuprincipal
    print ("    BIENVENIDO A GASOLINERA JAGUAR    ")
    ...
    if opcionselec == 4:
        ...
        print ("Mano de obra:")
        print ("        Salario Jornada Diurna:     Q", obrad)
        print ("        Salario Jornada Vespertina: Q", obrav)
        print ("        Salario Jornada Nocturna:   Q", obran)
